...
public class PolicyRuleEvaluator {
    ...
    public Map<String, Object> evaluateSecurityRule(
        ...
        if (securedSubnetCategories.contains("any") && securedVmCategories.contains("any")) {
            ...
            if (ipv6Only) {
                resultMap.put("exception_matching_ips", filterIpv6ExceptionMatches(union(learnedIps, virtualIps), extractPropertyAsList(securedNode, "exception_list")));
            }
    ...
    public Map<String, Object> evaluateSecurityRuleByIp(
        ...
        if (!subnetList.isEmpty()) {
            ...
            if (securedSubnetCategories.contains("any") && securedVmCategories.contains("any")) {
                ...
                if (ipv6Only) {
                    resultMap.put("exception_matching_ips", filterIpv6ExceptionMatches(matchedIps, extractPropertyAsList(securedNode, "exception_list")));
                }
                if (!ipv6Only && isIpv6TrafficAllowed) {
...
/**
    ...
    public Map<String, Object> evaluateUnresolvedVms(
        ...
        if (!hasSubnetCategories && !hasVmCategories) {
            ...
            if (ipv6Only) {
                resultMap.put("exception_matching_ips", filterIpv6ExceptionMatches(filteredIps, extractPropertyAsList(securedNode, "exception_list")));
            }
            if (!ipv6Only && isIpv6TrafficAllowed) {
